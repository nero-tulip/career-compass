...
const MODULES: ModuleDef[] = [
  {
    ...
    tier: 'free',
    icon: '👋',
    blurb: 'Basic context to personalize your experience: where you are, stage of life, and goals.',
  },
  {
    key: 'careerPrefs',
    ...
    tier: 'free',
    icon: '🎯',
    blurb: 'Macro preferences like environments and values. Helps tune matches and advice.',
  },
  {
    key: 'riasec',
    ...
    tier: 'free',
    icon: '🧩',
    blurb: 'Holland’s interests model (R-I-A-S-E-C) to reveal the types of work activities you enjoy.',
  },
  {
    key: 'big5',
    title: 'Big-5 Personality',
    subtitle: 'Deeper self-understanding',
    kind: 'quiz',
    tier: 'free',
    startPath: '/app/quiz/big5',
    icon: '🧠',
    blurb: 'IPIP-100 for a rich view of Extraversion, Agreeableness, Conscientiousness, Neuroticism, Openness.',
  },
  {
    key: 'results',
    title: 'Your Results',
    ...
    icon: '📊',
    blurb: 'A wrapped-style report that synthesizes all your inputs into clear next steps.',
  },
  {
    key: 'mentors',
    ...
    icon: '🤝',
    blurb: 'Curated mentors aligned to your goals and profile. (PRO)',
  },
  {
    key: 'resources',
    title: 'Resources',
    ...
    icon: '📚',
    blurb: 'Playbooks, templates, and curated reading to move faster.',
  },
];
